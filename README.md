# Welcome
This repository hosts the documentation for [Perpetual Intelligence® L.L.C.](https://perpetualintelligence.com/)'s managed services, cross-platform frameworks, and developer tools. We use [docfx](https://dotnet.github.io/docfx/) to build the [documentation site](https://docs.perpetualintelligence.com) straight from this repository.
