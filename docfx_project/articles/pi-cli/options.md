# [CliOptions](xref:PerpetualIntelligence.Terminal.Configuration.Options.CliOptions)
The terminal framework uses the options pattern to provide strongly typed access to groups of related settings. When configuration settings are isolated by scenario into separate classes, the host CLI terminal adheres to two crucial software engineering principles:
...
This article provides information on all the supported configuration options by the terminal framework.
...
### [AllowObsoleteArgument](xref:PerpetualIntelligence.Terminal.Configuration.Options.CheckerOptions.AllowObsoleteArgument)
...
### [StrictArgumentValueType](xref:PerpetualIntelligence.Terminal.Configuration.Options.CheckerOptions.StrictArgumentValueType)
...
### [ArgumentAlias](xref:PerpetualIntelligence.Terminal.Configuration.Options.ExtractorOptions.ArgumentAlias)
...
### [ArgumentAliasPrefix](xref:PerpetualIntelligence.Terminal.Configuration.Options.ExtractorOptions.ArgumentAliasPrefix)
The argument alias prefix if [ArgumentAlias](xref:PerpetualIntelligence.Terminal.Configuration.Options.ExtractorOptions.ArgumentAlias) is enabled. Defaults to `-`.
...
### [ArgumentPrefix](xref:PerpetualIntelligence.Terminal.Configuration.Options.ExtractorOptions.ArgumentPrefix)
...
### [ArgumentValueSeparator](xref:PerpetualIntelligence.Terminal.Configuration.Options.ExtractorOptions.ArgumentValueSeparator)
...
### [ArgumentValueWithIn](xref:PerpetualIntelligence.Terminal.Configuration.Options.ExtractorOptions.ArgumentValueWithIn)
...
### [CommandIdRegex](xref:PerpetualIntelligence.Terminal.Configuration.Options.ExtractorOptions.CommandIdRegex)
The Regex pattern for command identifier. Defaults to `^[A-Za-z0-9_-]*$`.

### [DefaultArgument](xref:PerpetualIntelligence.Terminal.Configuration.Options.ExtractorOptions.DefaultArgument)
...
### [DefaultArgumentValue](xref:PerpetualIntelligence.Terminal.Configuration.Options.ExtractorOptions.DefaultArgumentValue)
...
### [DataTypeHandler](xref:PerpetualIntelligence.Terminal.Configuration.Options.HandlerOptions.DataTypeHandler)
...
### [TextHandler](xref:PerpetualIntelligence.Terminal.Configuration.Options.HandlerOptions.TextHandler)
...
### [KeySource](xref:PerpetualIntelligence.Terminal.Configuration.Options.LicensingOptions.KeySource)
...
### [ProviderId](xref:PerpetualIntelligence.Terminal.Configuration.Options.LicensingOptions.ProviderId)
...
## [LoggingOptions](xref:PerpetualIntelligence.Terminal.Configuration.Options.LoggingOptions)
...
```
    ...
    options.Logging.ObscureErrorArgumentString = "####";
    [10:49:10 error] The license is not extracted or license is not valid. Please ensure you use the CLI hosted service. service=PerpetualIntelligence.Terminal.Integration.CliHostedService
```
