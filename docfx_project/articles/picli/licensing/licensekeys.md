...
> **Note**: The license expiry is based on your subscription plan. It is `31` days for monthly subscriptions, `365` days for yearly subscriptions, and `90` days for community subscriptions. See https://github.com/perpetualintelligence/picli/issues/20.
...
Currently, Reset will require redeploying your terminal. The fix is in progress, and it will enable customers to reset license keys without redeploying their terminals. See GitHub issue https://github.com/perpetualintelligence/picli/issues/22 that tracks this issue.
...
See GitHub issue https://github.com/perpetualintelligence/picli/issues/21 that will show a warning message before deleting.
