...
{
    /// <summary>
    /// The sample <c>dotnet cli</c> hosted service. This class enables UX customization for the cli terminal.
    /// </summary>
    public class DotNetCliHostedService : CliHostedService
    {
        ...
        public DotNetCliHostedService(IServiceProvider serviceProvider, CliOptions cliOptions, ILogger<CliHostedService> logger) : base(serviceProvider, cliOptions, logger)
        {
        }
