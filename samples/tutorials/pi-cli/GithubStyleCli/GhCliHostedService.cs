...
namespace GithubStyleCli
{
    ...
    /// </summary>
    public class GhCliHostedService : TerminalHostedService
    {
        /// <summary>
        ...
        public GhCliHostedService(IServiceProvider serviceProvider, TerminalOptions cliOptions, ILogger<GhCliHostedService> logger) : base(serviceProvider, cliOptions, logger)
        {
        }
